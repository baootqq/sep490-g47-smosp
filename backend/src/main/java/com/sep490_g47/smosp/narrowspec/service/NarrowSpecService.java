...
public interface NarrowSpecService {
    ...
    List<NsCourseResponse> getNarrowSpecCourses(UUID narrowSpecId);
    List<NsCourseResponse> updateNarrowSpecCourses(UUID narrowSpecId, List<NsCourseRequest> requests);
}
